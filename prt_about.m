...
fprintf(fid_about, '			<H2 id = "aims">Overview of the collection</H2>\n');
 ...
 fprintf(fid_about, '			<p>\n');
 fprintf(fid_about, '			The entries continue to change as the collection grows. \n');
 fprintf(fid_about, '			There are several reasons this can happen. Errors are spotted and corrected. More data is included. Assumptions about data quality change. Entries are split up by population.\n');
