...
fprintf(fid_Spec, '      -webkit-column-count: 3; /* Chrome, Safari, Opera */\n');
fprintf(fid_Spec, '      -moz-column-count: 3; /* Firefox */\n');
fprintf(fid_Spec, '      column-count: 3;\n');
fprintf(fid_Spec, '      width: 850px;\n');
fprintf(fid_Spec, '    }\n');
fprintf(fid_Spec, '  </style>\n');
fprintf(fid_Spec, '</HEAD>\n\n');
