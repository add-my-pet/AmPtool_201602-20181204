...
% Open entries_admin/taxa/html/entries_admin.html in a browser to see this manual.
...
% The tree has a root, called <../taxa/Animalia.txt *Animalia*>, nodes, which are names of taxa, and leaves, which are names of entries. 
...
% Changes in the sequence of entries on these pages can only be done by editing lists and generating the pages with 
% <prt_species_list.html *prt_species_list*> and <prt_species_tree_taxa_js.html *prt_species_tree_taxa_js*>.
%
...
%
% Function <../html/shstat.html *shstat*> can be used in symbolic mode for 1-, 2- and 3-variate data, as given in allStat.mat.
...
% The script <../mydata_shstat.m *mydata_shstat*> gives examples of use of shstat and shows how items can be added to figures that have been produced by shstat.